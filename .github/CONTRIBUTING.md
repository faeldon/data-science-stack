...
Love data-science-stack and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/faeldon/data-science-stack/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/data-science-stack.git
   # Navigate to the newly cloned directory
   cd data-science-stack
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/faeldon/data-science-stack.git
   ```
